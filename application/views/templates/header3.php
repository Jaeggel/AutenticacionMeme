    ...
    <body>
      ...
      <div class="container">
        ...
        <span class="icon-bar"></span>
            ...
            <a class="navbar-brand" href="<?php echo site_url('auth/cerrar_sesion') ?>">Autentificación</a>
          </div>
          <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav">

              <li><a href="<?php echo site_url('auth/cerrar_sesion') ?>"><span class="glyphicon glyphicon-remove-sign"></span> Salir</a></li>
            </ul>
          </div>
        </div>
      </div>
