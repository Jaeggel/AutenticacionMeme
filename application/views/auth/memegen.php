	...
	<div class="row main">
		...
		<div class="panel-heading">
	       <div class="panel-title text-center">
	       		<?php foreach ($auth as $tasks_item):?>
	       		<h1 class="title">Generador de Meme</h1>
	       		<h2 class="title">Memes</h2>
	       		<hr/>
	       			<label id="ced" value="<?php echo $tasks_item['cedula']; ?>">C.I.<?php echo $tasks_item['cedula']; ?></label>
	       		<hr/>
	       		<?php endforeach; ?>
	       	</div>
	    </div>
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="text" class="form-control" id='top-text' size="34" maxlength="34" placeholder="Texto Cabecera"/>
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="text" class="form-control" id='bottom-text' size="34" maxlength="34" placeholder="Texto Pie"/>
								</div>
							</div>
						</div>
					</div>
...
<div class="main-center">
	<div class="form-group ">
		<div>
			<button type="submit" id="authe" class="btn btn-primary btn-lg btn-block login-button">Registrar Meme</button>
		</div>
	</div>
</div>
